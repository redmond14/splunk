...
23. Deploy the config
![](attachments/deploy.png)

23. Log in to win10 PC via VM Console (or RD), assigne the IP address and default gateway (FTD's INSIDE interface).
![](attachments/client1.png)

24. Check internet access, ping, dns, web etc. You should see logs:
