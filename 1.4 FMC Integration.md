...
25. Deploy the config
---
![](attachments/deploy.png)

26. Log in to win10 PC via VM Console (or RD), assig the IP address and default gateway (FTD's INSIDE interface).
Note: use public DNS resolver: 208.67.222.222
---
![](attachments/client1.png)

27. Check internet access from the PC by performing tasks such as pinging, testing DNS resolution, and accessing websites. If everything is functioning correctly, you should see the corresponding logs:
